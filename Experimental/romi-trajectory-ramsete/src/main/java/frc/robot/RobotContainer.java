...
public class RobotContainer {
  ...
  private Command generateRamseteCommand() {
    ...
    Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
        ...
        List.of(
            // new Translation2d(0, 1), new Translation2d(1, 0),
            new Translation2d(0.5, 0.25), new Translation2d(1.0, -0.25),
    ...
    return new InstantCommand(() -> m_drivetrain.resetOdometry(exampleTrajectory.getInitialPose()), m_drivetrain)
        .andThen(new PrintCommand("*** Running Ramsete command for trajectory\n"))
        // next, we run the actual ramsete command
        .andThen(ramseteCommand)
        
        .andThen(new PrintCommand("*** Shutting down drive\n"))
