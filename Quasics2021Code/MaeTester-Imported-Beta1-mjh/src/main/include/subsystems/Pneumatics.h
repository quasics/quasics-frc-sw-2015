...
private:
    static constexpr frc::PneumaticsModuleType MODULE_TYPE{frc::PneumaticsModuleType::CTREPCM};
    // Compressor control
    frc::Compressor m_compressor{MODULE_TYPE};
    bool compressorEnabled = true;

    // Solenoid(s)
    frc::DoubleSolenoid m_intakeSolenoid{MODULE_TYPE,
    ...
    frc::DoubleSolenoid m_intakeSolenoid2{
        MODULE_TYPE, PneumaticsIds::IntakeSolenoid2Forward,
