...
GreenSeeking::GreenSeeking() {
}
/**
* Runs an iteration of the pipeline and updates outputs.
*/
void GreenSeeking::Process(cv::Mat& source0){
	//Step CV_resize0:
	//input
 ...
 */
cv::Mat* GreenSeeking::GetCvResizeOutput(){
 ...
 */
cv::Mat* GreenSeeking::GetHsvThresholdOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GreenSeeking::GetFindContoursOutput(){
 ...
 */
std::vector<std::vector<cv::Point> >* GreenSeeking::GetFilterContoursOutput(){
	 ...
	 */
	void GreenSeeking::cvResize(cv::Mat &src, cv::Size &dSize, double fx, double fy, int interpolation, cv::Mat &dst) {
	 ...
	 */
	void GreenSeeking::hsvThreshold(cv::Mat &input, double hue[], double sat[], double val[], cv::Mat &out) {
	 ...
	 */
	void GreenSeeking::findContours(cv::Mat &input, bool externalOnly, std::vector<std::vector<cv::Point> > &contours) {
