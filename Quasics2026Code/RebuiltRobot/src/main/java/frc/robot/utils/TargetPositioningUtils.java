...
public class TargetPositioningUtils {
  ...
  public static Translation2d getHubCenterLocation(Alliance alliance) {
    Distance x = switch (alliance) {
      case Red ->
        Constants.RebuiltFieldData.FIELD_LENGTH.minus(Constants.RebuiltFieldData.ALLIANCE_WALL_TO_HUB_CENTER);
      case Blue -> Constants.RebuiltFieldData.ALLIANCE_WALL_TO_HUB_CENTER;
    };

    Distance y = Constants.RebuiltFieldData.FIELD_WIDTH.div(2);
