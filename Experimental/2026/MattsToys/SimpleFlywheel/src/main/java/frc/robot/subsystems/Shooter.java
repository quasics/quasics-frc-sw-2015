...
public class Shooter extends SubsystemBase {
  ...
  public Shooter(int canID) {
    ...
    if (RobotBase.isSimulation()) {
      ...
      final LinearSystem<N1, N1, N1> plant = LinearSystemId.createFlywheelSystem(
          gearbox,
  ...
  public void simulationPeriodic() {
    ...
    double motorVoltage = motorSim.getAppliedOutput() * motorSim.getBusVoltage();
    ...
    motorSim.iterate(flywheelSim.getAngularVelocityRPM(), motorSim.getBusVoltage(), timeDeltaSecs);
  }
