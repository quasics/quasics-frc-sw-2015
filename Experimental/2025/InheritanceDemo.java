...
class Person {
  ...
  public String toString() { return "Person: " + name + ", Age: " + age; }
...
class CollegeStudent extends Person {
  ...
  public String toString() {
    return "CollegeStudent: " + name + ", Age: " + age +
...
class HighSchoolStudent extends Person {
  ...
  public String toString() {
    return "HighSchoolStudent: " + name + ", Age: " + age +
        ", Student ID: " + studentId + ", Grade Level: " + gradeLevel;
  }
...
public class InheritanceDemo {
  ...
  public static void main(String[] args) {
    ...
    CollegeStudent collegeStudent =
        new CollegeStudent("Alice", 20, "CS123", "Computer Science");
    HighSchoolStudent highSchoolStudent =
        new HighSchoolStudent("Bob", 16, "HS456", "10th Grade");
