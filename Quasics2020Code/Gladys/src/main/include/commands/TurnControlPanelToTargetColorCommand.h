...
class TurnControlPanelToTargetColorCommand
 ...
 /**
  * Gets target color and stops if no data is recieved. Starts the motor if data is recieved and sets the target color to the color recieved from the gameData.
 **/
