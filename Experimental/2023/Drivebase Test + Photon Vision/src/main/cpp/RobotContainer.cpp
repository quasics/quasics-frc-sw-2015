...
frc2::CommandPtr RobotContainer::GetAutonomousCommand() {
  frc::Pose2d startingPose = frc::Pose2d{0_m, 0_m, 0_deg};
  frc::Pose2d endingPose = frc::Pose2d{3_m, 0_m, 0_deg};
  return BuildTrajectory(startingPose, endingPose, true, &m_drive);
}
