...
public final class Constants {
  // For now, we're going to use PWMSparkMax configurations in simulation, due
  // to a "crash bug" in Rev's code on Mac OS (which is where Mr. Healy most
  // often develops his "toys").
