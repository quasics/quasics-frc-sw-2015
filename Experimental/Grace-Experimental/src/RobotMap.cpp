...
std::shared_ptr<frc::AnalogGyro> RobotMap::navAltGyro;
...
void RobotMap::init() {
    ...
    navAltGyro.reset(new frc::AnalogGyro(0));
    lw->AddSensor("NavAlt", "Gyro", navAltGyro);
    navAltGyro->SetSensitivity(0.007);
    ...
    navAltGyro.reset(new frc::AnalogGyro(0));
    navAltGyro->SetSensitivity(0.007);
    SetNameAndSubsystem(*navAltGyro, "NavAlt", "Gyro");
