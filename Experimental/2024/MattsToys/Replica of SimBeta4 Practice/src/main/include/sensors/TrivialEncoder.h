...
//this is really similar to the IGyro. Basically there is no more common functionality so this wrapper
//is created
...
//and now this is acocunting for the 2 different types of encoders that can be passed in
//and also for the instance that nothing gets passed in
