...
public:
    ...
    static std::shared_ptr<Encoder> driveSystemLeftEncoder;
    ...
    static std::shared_ptr<DoubleSolenoid> intakePusher;
    ...
    static std::shared_ptr<Encoder> intakeArmRightArmEncoder;
