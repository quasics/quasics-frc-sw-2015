...
std::shared_ptr<MrPlow> Robot::mrPlow;
...
void Robot::RobotInit() {
	...
	autonomousCommand.reset(new AutonomousCommand(1));
	// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=AUTONOMOUS
	updaterCommand.reset(new DashboardUpdater ());
