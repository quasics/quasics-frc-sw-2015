...
public:
  ...
  void InstallSliders()
  {
    int low_h(0), low_s(0), low_v(0), high_h(179), high_s(255), high_v(255);
...
private:
  void LoadFromFile(int &low_h, int &low_s, int &low_v, int &high_h,
  ...
  void ConfigureShuffleboard(int low_h, int low_s, int low_v, int high_h,
                             int high_s, int high_v)
  {
    ...
    wpi::StringMap<std::shared_ptr<nt::Value>>
        saturationAndValueSliderProperties{
            {"min", nt::Value::MakeDouble(0)},
