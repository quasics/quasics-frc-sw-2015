...
void Robot::RobotInit() {
	...
	chooser.AddOption("Left Position", leftPlacementCommand);
	chooser.AddOption("Middle Position", middlePlacementCommand);
	chooser.AddOption("Right Position", rightPlacementCommand);
