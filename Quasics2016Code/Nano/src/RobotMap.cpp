...
std::shared_ptr<Encoder> RobotMap::intakeArmLeftEncoder12;
...
void RobotMap::init() {
    ...
    lw->AddActuator("IntakeArm", "LeftArm", std::static_pointer_cast<Spark>(intakeArmLeftArm));
    
    intakeArmRightArm.reset(new Spark(7));
    lw->AddActuator("IntakeArm", "RightArm", std::static_pointer_cast<Spark>(intakeArmRightArm));
    
    intakeArmLeftEncoder12.reset(new Encoder(4, 5, false, Encoder::k4X));
    lw->AddSensor("IntakeArm", "LeftEncoder12", intakeArmLeftEncoder12);
    intakeArmLeftEncoder12->SetDistancePerPulse(1.0);
    intakeArmLeftEncoder12->SetPIDSourceType(PIDSourceType::kRate);
    intakeArmLeftEncoder.reset(new Encoder(6, 7, true, Encoder::k4X));
    ...
    lw->AddActuator("Intake Shooter", "LeftIntakeWheel", std::static_pointer_cast<Victor>(intakeShooterLeftIntakeWheel));
    
    intakeShooterRightIntakeWheel.reset(new Victor(5));
    lw->AddActuator("Intake Shooter", "RightIntakeWheel", std::static_pointer_cast<Victor>(intakeShooterRightIntakeWheel));
