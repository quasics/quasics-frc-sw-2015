...
public class RainbowLighting extends CommandBase {
    /** The subsystem we'll work with to set the lights. */
    final Lighting subsystem;
    ...
    private final Lighting.ColorFunctor colorFunction;

    /** Creates a new RainbowLightingCommand. */
    public RainbowLighting(Lighting subsystem) {
        this(subsystem, 0, 0);
    }
     ...
     *                               stage
     */
    public RainbowLighting(Lighting subsystem, double secondsBeforeAdvancing) {
     ...
     *                               minimum of 0.)
     */
    public RainbowLighting(Lighting subsystem, double secondsBeforeAdvancing, int extraGapBetweenColors) {
