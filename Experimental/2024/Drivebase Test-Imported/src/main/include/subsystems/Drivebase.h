...
class Drivebase : public frc2::SubsystemBase {
 ...
 private:
  ...
  //instead of this for motors porting over own code
  ...
  rev::SparkRelativeEncoder m_leftFrontEncoder = m_leftFront.GetEncoder(rev::SparkRelativeEncoder::Type::kHallSensor);
  rev::SparkRelativeEncoder m_rightFrontEncoder = m_rightFront.GetEncoder(rev::SparkRelativeEncoder::Type::kHallSensor);
  rev::SparkRelativeEncoder m_leftBackEncoder = m_leftBack.GetEncoder(rev::SparkRelativeEncoder::Type::kHallSensor);
  rev::SparkRelativeEncoder m_rightBackEncoder = m_rightBack.GetEncoder(rev::SparkRelativeEncoder::Type::kHallSensor);
  ...
  ctre::phoenix6::hardware::Pigeon2 m_gyro{SensorIds::PIDGEON_CAN_ID};
