...
public class SimpleLightingCommand extends CommandBase {
  ...
  /**
   * Creates a new SimpleLightingCommand.
   *
   * @param subsystem The subsystem used by this command.
   */
  public SimpleLightingCommand(LightingSubsystem subsystem) {
   ...
   * @param subsystem The subsystem used by this command.
   */
  public SimpleLightingCommand(LightingSubsystem subsystem, Mode mode) {
