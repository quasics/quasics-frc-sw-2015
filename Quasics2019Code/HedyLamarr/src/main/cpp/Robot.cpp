...
std::shared_ptr<HatchPanelManipulator> Robot::hatchPanelManipulator;
std::shared_ptr<NewHatchPanelManipulator> Robot::newHatchPanelManipulator;
...
void Robot::RobotInit() {
  // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
    ...
    hatchPanelManipulator.reset(new HatchPanelManipulator());
    newHatchPanelManipulator.reset(new NewHatchPanelManipulator());
