...
#include "Commands/FPSDriveLinear.h"
#include "Commands/FPSDriveLog.h"
...
OI::OI() {
    ...
    SmartDashboard::PutData("FPS Drive Log", new FPSDriveLog());
    SmartDashboard::PutData("FPS Drive Linear", new FPSDriveLinear());
