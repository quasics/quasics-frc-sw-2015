...
public class RobotContainer {
  ...
  private void addOverallSelectorToSmartDashboard() {
    m_overallOptions.setDefaultOption(
        Constants.AutonomousSelectedOperation.doNothing,
        Constants.AutonomousSelectedOperation.doNothing);
    m_overallOptions.addOption(Constants.AutonomousSelectedOperation.GTFO,
        Constants.AutonomousSelectedOperation.GTFO);
    m_overallOptions.addOption(Constants.AutonomousSelectedOperation.score1,
        Constants.AutonomousSelectedOperation.score1);
    ...
    m_overallOptions.addOption(Constants.AutonomousSelectedOperation.score2,
        Constants.AutonomousSelectedOperation.score2);
    ...
    m_overallOptions.addOption(Constants.AutonomousSelectedOperation.score3,
        Constants.AutonomousSelectedOperation.score3);
    ...
    m_overallOptions.addOption(Constants.AutonomousSelectedOperation.score4,
        Constants.AutonomousSelectedOperation.score4);
  ...
  private void addScore2OptionsToSmartDashboard() {
    m_score2Options.setDefaultOption(Constants.AutonomousScore2Options.none,
        Constants.AutonomousScore2Options.none);
  ...
  private void addScore3OptionsToSmartDashboard() {
    m_score3Options.setDefaultOption(Constants.AutonomousScore3Options.none,
        Constants.AutonomousScore3Options.none);
    m_score3Options.addOption(Constants.AutonomousScore3Options.amp,
        Constants.AutonomousScore3Options.amp);
  ...
  private void addButtonsToSmartDashboard() {
    SmartDashboard.putData("set motor 6V",
        new InstantCommand(() -> m_drivebase.setVoltages(6, 6)));
    SmartDashboard.putData("Reset odometry",
        new InstantCommand(() -> m_drivebase.resetOdometry()));
    SmartDashboard.putData("Transition Roller Forward",
        new RunTransitionRoller(m_transitionRoller, .1, true));
    SmartDashboard.putData(
        "Intake Roller Forward", new RunIntake(m_intakeRoller, .5, true));
    SmartDashboard.putData("Enable Breaking Mode",
        new InstantCommand(() -> m_drivebase.enableBreakingMode(true)));
    SmartDashboard.putData("Enable Coasting Mode",
        new InstantCommand(() -> m_drivebase.enableBreakingMode(false)));
    SmartDashboard.putData("Reset Revolutions",
        new InstantCommand(() -> m_climbers.ResetRevolutions()));
    SmartDashboard.putData("Set Revolutions",
        new InstantCommand(() -> m_climbers.SetRevolutions()));
    SmartDashboard.putData("Lighting red",
        new InstantCommand(() -> m_lights.setStripColor(255, 0, 0)));
    SmartDashboard.putData("Lighting blue",
        new InstantCommand(() -> m_lights.setStripColor(0, 0, 255)));
  }
  ...
  private void configureBindings() {
    ...
    switchDriveTrigger = new Trigger(()
                                         -> m_driverController.getRawButton(
                                             Constants.LogitechGamePad.BButton))
                             .onTrue(new InstantCommand(
                                 () -> { m_switchDrive = !m_switchDrive; }));

    if (ARCADE_DRIVE) {
      m_drivebase.setDefaultCommand(new ArcadeDrive(
          m_drivebase, m_arcadeDriveRightStick, m_arcadeDriveLeftStick));
    } else {
      m_drivebase.setDefaultCommand(new TankDrive(
          m_drivebase, m_tankDriveLeftStick, m_tankDriveRightStick));
    }
  }
  ...
  private Command transitionDelay(Shooter shooter, double speed) {
    return Commands.sequence(new WaitCommand(0.75),
        new TimedRunShooter(shooter, speed, Seconds.of(3.0), true));
  }
  ...
  private Command shootingSequence(
    ...
    // Autos
    return Commands.parallel(
        new TimedRunShooter(shooter, power, Seconds.of(4.0), true),
  ...
  private Command transitionDelay(TransitionRoller transitionRoller) {
    return Commands.sequence(new WaitCommand(0.75),
        new RunTransitionRoller(transitionRoller, .5, true));
  }

  private Command transitionDelay(
      TransitionRoller transitionRoller, double delay) {
    return Commands.sequence(new WaitCommand(delay),
        new RunTransitionRoller(transitionRoller, .5, true));
  }
  ...
  private void ConfigureDriverButtons() {
    Trigger ExtendClimber =
        new Trigger(()
                        -> m_driverController.getRawButton(
                            Constants.LogitechGamePad.YButton))
            .whileTrue(new MoveClimbers(m_climbers, true));
    Trigger RetractClimber =
        new Trigger(()
                        -> m_driverController.getRawButton(
                            Constants.LogitechGamePad.AButton))
            .whileTrue(new MoveClimbers(m_climbers, false));
    Trigger IntakeNote =
        new Trigger(()
                        -> m_driverController.getRawButton(
                            Constants.LogitechGamePad.LeftTrigger))
            .whileTrue(IntakeHelperCommandUntilBeamBroken(true));
    Trigger DropNote =
        new Trigger(()
                        -> m_driverController.getRawButton(
                            Constants.LogitechGamePad.RightTrigger))
            .whileTrue(IntakeHelperCommand(false));

    sensorTrigger =
        new Trigger(()
                        -> m_driverController.getRawButton(
                            Constants.LogitechGamePad.StartButton))
            .onTrue(new InstantCommand(() -> {
              m_enableSensors = !m_enableSensors;
              System.out.println(
                  m_enableSensors ? "sensors enabled" : "sensors disabled");
            }));
  }

  private void ConfigureOperatorButtons() {
    Trigger SpeakerScoringSequence = new Trigger(
        () -> m_operatorController.getRawButton(XboxController.Button.kX.value))
                                         .whileTrue(shootingSequence(
                                             m_transitionRoller, m_shooter,
                                             0.75));
    Trigger AmpScoringSequence = new Trigger(
        () -> m_operatorController.getRawButton(XboxController.Button.kB.value))
                                     .whileTrue(shootingSequence(
                                         m_transitionRoller, m_shooter, 0.25));
    Trigger SpeakerScoring =
        new Trigger(()
    ...
    Trigger TransitionForward = new Trigger(
        () -> m_operatorController.getRawButton(XboxController.Button.kY.value))
                                    .whileTrue(new RunTransitionRoller(
                                        m_transitionRoller, .3, false));
    Trigger TransitionBackward = new Trigger(
        () -> m_operatorController.getRawButton(XboxController.Button.kA.value))
                                     .whileTrue(new RunTransitionRoller(
                                         m_transitionRoller, .3, true));
  }
  ...
  public Command getAutonomousCommand() {
    ...
    return Autos.getAutonomousCommand(m_drivebase, m_intakeRoller,
        m_transitionRoller, m_shooter, overallOperation, positionOption,
