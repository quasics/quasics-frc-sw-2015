...
OI::OI() {
  ...
  TopElevatorButton.reset(new frc::JoystickButton(operatorStick.get(), XBox_LeftTrigger));
  TopElevatorButton->WhenPressed(new MoveToTop());

  BottomElevatorButton.reset(new frc::JoystickButton(operatorStick.get(), XBox_RightTrigger));
  BottomElevatorButton->WhenPressed(new MoveToBottom());

  PositionOneElevatorButton.reset(new frc::JoystickButton(operatorStick.get(), XBox_RightButton));
  PositionOneElevatorButton->WhenPressed(new MoveToPositionOne());
  
  PositionTwoElevatorButton.reset(new frc::JoystickButton(operatorStick.get(), XBox_LeftButton));
