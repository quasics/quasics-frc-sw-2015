...
public:
	...
	//Encoder Readings
	int GetRawEncoder (EncoderSide whichSide);			//Counts
	double GetEncoderDistance (EncoderSide whichSide);	//Meters
	double GetEncoderRate (EncoderSide whichSide);		//Meters/Second
