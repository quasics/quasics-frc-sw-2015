...
public final class ReefscapeConstants {
  ...
  public static final Distance STARTING_LINE_OFFSET = Meters.of(1.2);

  /**
   * Robot distance from east side of the field when on the Blue alliance's
   * starting line.
   */
  public static final Distance BLUE_STARTING_LINE = FIELD_LENGTH.div(2).minus(STARTING_LINE_OFFSET);

  /**
   * Robot distance from east side of the field when on the Red alliance's
   * starting line.
   */
  public static final Distance RED_STARTING_LINE = FIELD_LENGTH.div(2).plus(STARTING_LINE_OFFSET);

  /**
   * Robot distance from south side of the field when in front of the
   * "top-most" ball.
   */
  public static final Distance TOP_BALL_HEIGHT = Meters.of(5.9);

  /**
   * Robot distance from south side of the field when in front of the "middle"
   * ball.
   */
  public static final Distance MIDDLE_BALL_HEIGHT = Meters.of(4);

  /**
   * Robot distance from south side of the field when in front of the
   * "bottom-most" ball.
   */
  public static final Distance BOTTOM_BALL_HEIGHT = Meters.of(2.25);
}
