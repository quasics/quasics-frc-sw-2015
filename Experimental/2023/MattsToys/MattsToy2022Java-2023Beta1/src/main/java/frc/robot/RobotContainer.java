...
public class RobotContainer {
  ...
  private static RobotSettings loadSettingsOrDefaults() {
    ...
    if (LOAD_SETTINGS_FROM_DEPLOYED_FILES) {
      ...
      // SmartDashboard.delete(LOADING_ROBOT_PROPERTY_NAME);  // TODO(mjh): Port this.
  ...
  private void configureSmartDashboard() {
    ...
    if (LOAD_SETTINGS_FROM_DEPLOYED_FILES) {
      // SmartDashboard.delete("Store Sally");  // TODO(mjh): Port this.
      // SmartDashboard.delete("Store Mae");    // TODO(mjh): Port this.
      // SmartDashboard.delete("Store Nike");   // TODO(mjh): Port this.
    } else {
