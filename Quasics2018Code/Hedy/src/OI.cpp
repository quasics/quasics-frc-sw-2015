...
OI::OI() {
	...
	//frc::SmartDashboard::PutData("Gyro @ .25 power", new GyroTurn(90, .25));
	//frc::SmartDashboard::PutData("Gyro @ .15 power", new GyroTurn(90, .15));
	//frc::SmartDashboard::PutData("Gyro @ .125 power", new GyroTurn(90, .125));
	//frc::SmartDashboard::PutData("Gyro @ .10 power", new GyroTurn(90, .10));
