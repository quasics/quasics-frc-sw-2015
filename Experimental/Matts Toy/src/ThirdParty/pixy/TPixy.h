...
// Initially fetched from https://github.com/Team5593/pixy/tree/master/src/host/roborio/C%2B%2B
// by mjhealy on 04Feb2017.
// Note: Given the compile/run-time issues that a brief review revealed, I have
