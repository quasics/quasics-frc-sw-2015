...
public interface IMotorControllerPlus extends MotorController {
  ...
  static IMotorControllerPlus forPWMMotorController(PWMMotorController controller) {
    return new MotorControllerPlus(controller, () -> Volts.of(controller.getVoltage()), () -> controller.close());
  }
  ...
  public class MotorControllerPlus implements IMotorControllerPlus {
    ...
    public MotorControllerPlus(MotorController controller, Supplier<Voltage> voltageSupplier, Closeable closer) {
