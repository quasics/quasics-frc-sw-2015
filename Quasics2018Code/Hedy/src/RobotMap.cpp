...
// #define USE_ROBOT_BUILDER_INIT
    ...
    driveBaseleftRearMotor.reset(new frc::PMWVictorSPX(3));
    lw->AddActuator("DriveBase", "leftRearMotor", std::static_pointer_cast<frc::PMWVictorSPX>(driveBaseleftRearMotor));
    
    driveBaseleftFrontMotor.reset(new frc::PMWVictorSPX(2));
    lw->AddActuator("DriveBase", "leftFrontMotor", std::static_pointer_cast<frc::PMWVictorSPX>(driveBaseleftFrontMotor));
    ...
    driveBaserightFrontMotor.reset(new frc::PMWVictorSPX(0));
    lw->AddActuator("DriveBase", "rightFrontMotor", std::static_pointer_cast<frc::PMWVictorSPX>(driveBaserightFrontMotor));
    
    driveBaserightRearMotor.reset(new frc::PMWVictorSPX(1));
    lw->AddActuator("DriveBase", "rightRearMotor", std::static_pointer_cast<frc::PMWVictorSPX>(driveBaserightRearMotor));
