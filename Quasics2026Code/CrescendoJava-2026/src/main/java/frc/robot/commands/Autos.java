...
public final class Autos {
  ...
  public static Command intakeHelperCommand(
    ...
    return Commands.race(
        new RunTransitionUntilBeamBroken(transitionRoller, transitionSpeed, true, true),
  ...
  public static Command score1GTFO(Drivebase drivebase, TransitionRoller transitionRoller,
      Shooter shooter, IntakeRoller intakeRoller, String position, String color) {
    return Commands.sequence(score1(transitionRoller, shooter), GTFO(drivebase, position, color));
  }
  ...
  public static Command score2LeftOfSpeaker(Drivebase drivebase, TransitionRoller transitionRoller,
      Shooter shooter, IntakeRoller intakeRoller, String color) {
    return Commands.sequence(
  ...
  public static Command score2RightOfSpeaker(Drivebase drivebase, TransitionRoller transitionRoller,
      Shooter shooter, IntakeRoller intakeRoller, String scoreOption, String color) {
  ...
  public static Command score2(Drivebase drivebase, String position,
      ...
      String scoreOption, String color) {
    if (position == AutonomousStartingPositions.leftOfSpeaker) {
      ...
      return Commands.sequence(score1(transitionRoller, shooter),
          score2RightOfSpeaker(
              drivebase, transitionRoller, shooter, intakeRoller, scoreOption, color));
    } else if (position == AutonomousStartingPositions.farField) {
  ...
  public static Command score3LeftOfSpeaker(Drivebase drivebase, TransitionRoller transitionRoller,
      Shooter shooter, IntakeRoller intakeRoller, String color) {
    return Commands.sequence(
        score2LeftOfSpeaker(drivebase, transitionRoller, shooter, intakeRoller, color),
  ...
  public static Command score3RightOfSpeaker(Drivebase drivebase, TransitionRoller transitionRoller,
      Shooter shooter, IntakeRoller intakeRoller, String color) {
    return Commands.sequence(
  ...
  public static Command getAutonomousCommand(Drivebase drivebase, IntakeRoller intakeRoller,
    ...
    if (overallOperation == AutonomousSelectedOperation.doNothing) {
      ...
      return Commands.sequence(resetOdometryToStartingPosition(drivebase, positionOption, color),
          score2(drivebase, positionOption, transitionRoller, shooter, intakeRoller, score2Option,
              color));
