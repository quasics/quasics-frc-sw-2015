...
void RobotMap::init() {
    ...
    driveBaseLeftMotors = std::make_shared<frc::SpeedControllerGroup>(*driveBaseleftFrontMotor, *driveBaseRearLeftMotor);
    driveBaseLeftMotors->SetSubsystem("DriveBase");
    driveBaseLeftMotors->SetName("LeftDriveMotors");

    driveBaseRightMotors = std::make_shared<frc::SpeedControllerGroup>(*driveBaseFrontRightMotor, *driveBaseRearRightMotor);
    driveBaseRightMotors->SetSubsystem("DriveBase");
    driveBaseRightMotors->SetName("RightDriveMotors");
#else
