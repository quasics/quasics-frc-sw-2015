...
class Pneumatics : public frc2::SubsystemBase {
 ...
 public:
  ...
  private:
   // Compressor control
   frc::Compressor m_compressor{PneumaticsIds::DefaultSolenoidId, frc::PneumaticsModuleType::CTREPCM};
   bool compressorEnabled = true;

   // Solenoid(s)
   frc::DoubleSolenoid m_intakeSolenoid{PneumaticsIds::DefaultSolenoidId, frc::PneumaticsModuleType::CTREPCM,
   ...
   frc::DoubleSolenoid m_intakeSolenoid2{
       PneumaticsIds::DefaultSolenoidId, frc::PneumaticsModuleType::CTREPCM, PneumaticsIds::IntakeSolenoid2Forward,
