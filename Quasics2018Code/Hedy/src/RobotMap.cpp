...
// #define USE_ROBOT_BUILDER_INIT
    ...
    driveBaseDifferentialDrive.reset(new frc::DifferentialDrive(*driveBaseLeftMotors, *driveBaseRightMotors));
    setNameAndSubsystem(*driveBaseDifferentialDrive, "DriveBase", "Differential Drive");
    ...
    driveBaseLeftRearMotor.reset(new frc::Spark(3));
    lw->AddActuator("DriveBase", "Left Rear Motor", std::static_pointer_cast<frc::Spark>(driveBaseLeftRearMotor));
    ...
    driveBaseRightFrontMotor.reset(new frc::Spark(0));
    lw->AddActuator("DriveBase", "Right Front Motor", std::static_pointer_cast<frc::Spark>(driveBaseRightFrontMotor));
    
    driveBaseRightRearMotor.reset(new frc::Spark(1));
    lw->AddActuator("DriveBase", "Right Rear Motor", std::static_pointer_cast<frc::Spark>(driveBaseRightRearMotor));
