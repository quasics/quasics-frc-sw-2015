...
class ExpandedLEDSerialControllerMega: public LEDController {
  public:
	enum Mode {
    ...
    ExpandedLEDSerialControllerMega (unsigned int redPin, unsigned int greenPin, unsigned int bluePin, unsigned int whitePin, unsigned int baseLoopSeconds);
